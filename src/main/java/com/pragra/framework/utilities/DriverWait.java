package com.pragra.framework.utilities;
...
public class DriverWait {
	...
	public enum WaitTime {
		ONESECOND(1), TWOSECONDS(2), FIVESECONDS(5), TENSECONDS(10), TWENTYSECONDS(20), FIFTYSECONDS(50), ONEMINUTE(60),TWOMINUTES(120);
	...
	public static boolean isElementEnabled(WebElement element, WaitTime waitTime) {
		long before = System.currentTimeMillis();
		long after = 0;
		do {
			try {
